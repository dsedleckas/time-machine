 ...
 */
    ...
    void TimeMachineHardware::Init()
    {
        ...
        /*
        dsy_gpio scl;
        scl.mode = DSY_GPIO_MODE_OUTPUT_PP;
        scl.pull = DSY_GPIO_PULLUP;
        scl.pin  = {DSY_GPIOB, 10};
        dsy_gpio_init(&scl);

        dsy_gpio sda;
        sda.mode = DSY_GPIO_MODE_OUTPUT_PP;
        sda.pull = DSY_GPIO_PULLUP;
        sda.pin  = {DSY_GPIOB, 11};
        dsy_gpio_init(&sda);
        */
        ...
        //gate_in_1.Init((dsy_gpio_pin *)&TimeMachineHardware::B10);
    ...
    void
    TimeMachineHardware::ChangeAudioCallback(AudioHandle::InterleavingAudioCallback cb)
    {
        audio.ChangeCallback(cb);
    }
    ...
    void
    TimeMachineHardware::SetAudioSampleRate(SaiHandle::Config::SampleRate sample_rate)
    {
